  ...
  return (
    <>
      ...
      <main className="relative mx-auto flex w-full max-w-4xl flex-col gap-10 px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
        ...
        >
          <span aria-hidden className="pointer-events-none absolute -left-14 top-0 h-52 w-52 rounded-full bg-linear-to-br from-primary/20 via-primary/8 to-transparent blur-2xl" />
          <span aria-hidden className="pointer-events-none absolute -right-10 bottom-0 h-44 w-44 rounded-full bg-linear-to-br from-accent/25 via-accent/10 to-transparent blur-2xl" />
          ...
          <div className="relative grid gap-6 lg:grid-cols-[1fr_200px] lg:items-start">
            <div className="flex flex-col gap-5">
              ...
              >
                An anonymous Q&A board for your classroom.{" "}
                <span className="font-display italic text-foreground">
                  Ask questions, vote for the best ones.
                </span>{" "}
                Realtime updates for everyone in the room.
              </motion.p>
              ...
              >
                <StatsPill label="Questions" value={questions.length} />
                <StatsPill label="Likes" value={totalLikes} accent />
            ...
            >
              ...
              <p className="text-xs leading-relaxed text-muted-foreground">
                Submit your questions anonymously. The best ones rise to the top.
              </p>
            </motion.aside>
          </div>
        </motion.header>
        ...
        <section aria-label="Question List" className="flex flex-col gap-3">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
